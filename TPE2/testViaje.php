...
$pasajero1 = new Pasajero ("Luciana","Romano",42604817,2994056653 );
$pasajero2 = new Pasajero ("Nahuel", "Ruiz", 40443386,299097006);
$pasajero3 = new Pasajero ("Olivia", "Ruiz Romano", 59118307,2996329400);
